...
import { AnyFunction, AnyObject } from '../types/mod.ts';
...
export type AbstractChildren = AbstractNode[] | AbstractNode;
...
> {
  ...
  children?: (AbstractText | AbstractElement | AbstractComponent)[] | AbstractText | AbstractElement | AbstractComponent
}
...
export type AnyPropComponent =
  (properties: AnyObject) => AbstractChildren;
